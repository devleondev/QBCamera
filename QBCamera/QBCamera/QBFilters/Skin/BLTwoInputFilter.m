...
#import "BLTwoInputFilter.h"

NSString *const BLTwoInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation BLTwoInputFilter
#pragma mark -
#pragma mark Initialization and teardown

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    if (!(self = [self initWithVertexShaderFromString:BLTwoInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
